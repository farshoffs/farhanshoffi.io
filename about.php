...
<!-- Mirrored from bostamihtml.ibthemespro.com/aboutTwo.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jul 2024 05:29:29 GMT -->
<head>
    <!-- common meta tags -->
    <meta charset="UTF-8" />
            ...
            <div class="container">
                ...
                <header class="flex justify-between items-center fixed top-0 left-0 w-full lg:static z-[1111111111]">
                    ...
                    <nav class="hidden lg:block">
                        <ul class="flex my-12">
                            <li>
                                <a class="menu-item-two" href="homePage.html">
                                    <span class="mr-2 text-base">
                                        <i class="fa-solid fa-house"></i>
                                    </span> Home </a>
                            </li>
                            <li>
                                <a class="menu-item-two-active" href="aboutTwo.html">
                                    <span class="mr-2 text-base">
                    ...
                    <nav id="navbar" class="hidden lg:hidden">
                        <ul
                            ...
                            <li>
                                <a class="mobile-menu-items" href="homePage.html">
                                    <span class="mr-2 text-xl">
                                        <i class="fa-solid fa-house"></i>
                                    </span> Home </a>
                            </li>
                            <li>
                                <a class="mobile-menu-items-active" href="aboutTwo.html">
                                    <span class="mr-2 text-xl">
                                        <i class="fa-regular fa-user"></i>
                                    </span> About </a>
                            </li>
...
<!-- Mirrored from bostamihtml.ibthemespro.com/aboutTwo.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jul 2024 05:29:34 GMT -->
</html>